...
public class VShowActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        ItemTouchHelper touchHelper = new ItemTouchHelper(new VTouchHelper(adapter));
                ...
                .addOnCompleteListener(new OnCompleteListener<QuerySnapshot>() {
                    ...
                    public void onComplete(@NonNull Task<QuerySnapshot> task) {
                        ...
                        for(DocumentSnapshot snapshot : task.getResult()){
                            ...
                            VModel model = new VModel(snapshot.getString("id"), snapshot.getString("name"), snapshot.getString("phone"),
